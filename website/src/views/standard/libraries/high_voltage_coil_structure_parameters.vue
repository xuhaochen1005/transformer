  ...
  <div class="app-container">
    ...
    <div class="main-table">
      ...
      >
        ...
        <el-table-column
          :label="t('permission_table.ptype')"
          width="180px"
          align="center"
        >
          <template #default="{row}">
      ...
      createData() {
        ...
        form.validate(async(valid: any) => {
          if (valid) {
            ...
            console.log('wwww', ArticleModel.author)
